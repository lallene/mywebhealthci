                                ...
                                <div class="accordion" id="accordionExample1">
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-body">
                                            <form class="row g-4 accordion-body"  method="post" action="{{ route('justificatif_externe.store') }}" enctype="multipart/form-data">
                                                @csrf
                                        ...
                                        <div class="">
                                            <div class="row g-4 accordion-body">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-select" name="arret_maladie_recu" id="">
                                                        <option value="1">Oui</option>
                                                        <option value="0">Non</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-select" name="dose_covid" id="dose_covid">
