                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-12 text-right pb-2">
                                <a href="{{ route("profil.create") }}" class="btn btn-primary"><i class="fa fa-plus"></i> Ajouter</a>
                                                        ...
                                                        <div class="dropdown_section">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="{{route('profil.edit', $role->id)}}">Modifier</a>
                                                                    <a class="dropdown-item" href="{{ URL::to('profil/permission/'.$role->id) }}">Afficher Permissions</a>
