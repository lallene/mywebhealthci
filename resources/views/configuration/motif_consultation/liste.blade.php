        ...
        <div class="row column_title">
            <div class="col-md-12">
                <div class="page_title">
                    <h2>Liste des motifs de consultations</h2>
                </div>
            </div>
        </div>
                                                        ...
                                                        <div class="dropdown_section">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="{{route('motif_consultation.edit', $motif->id)}}">Modifier</a>
                                                                    <form action="{{ route('motif_consultation.destroy', $motif->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
