                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-12 text-right pb-2">
                                <a href="{{ route("fonction.create") }}" class="btn btn-primary"><i class="fa fa-plus"></i> Ajouter</a>
                                                        ...
                                                        <div class="dropdown_section">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="{{route('fonction.edit', $fonction->id)}}">Modifier</a>
                                                                    <form action="{{ route('fonction.destroy', $fonction->id) }}" method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
