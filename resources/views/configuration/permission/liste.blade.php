                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-sm-12 text-right pb-2">
                                <a href="{{ route("permission.create") }}" class="btn btn-primary"><i class="fa fa-plus"></i> Ajouter</a>
                                                        ...
                                                        <div class="dropdown_section">
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="{{route('permission.edit', $permission->id)}}">Modifier</a>
